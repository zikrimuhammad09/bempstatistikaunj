...
<body class="hold-transition sidebar-mini layout-navbar-fixed layout-fixed">
                            ...
                            <div class="card card-primary">
                                ...
                                <form id="quickForm" method="post">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" value="<?= $anggota["id"]; ?>" id="exampleInputId" name="id">

                                        <div class="form-group">
                                            <label for="exampleInputName">Nama Lengkap</label>
                                            <input type="password" value="<?= $anggota["nama"]; ?>" class="form-control" id="exampleInputName" name="name" placeholder="Masukkan Nama Lengkap">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputNim">NIM</label>
                                            <input type="password" value="<?= $anggota["nim"]; ?>" class=" form-control" id="exampleInputNim" name="nim" placeholder="Masukkan NIM">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" value="<?= $anggota["email"]; ?>" class="form-control" id="exampleInputEmail1" name="email" placeholder="Masukkan Email Aktif">
                                        </div>
    ...
    <!-- memperbaiki custom select angkatan dan departemen -->
    <script>
    ...
    <script>
        ...
        <?php if (isset($berhasil)) : ?>
            $("#exampleInputName").attr('value', '<?= $_POST["name"] ?>');
            $("#exampleInputNim").attr('value', '<?= $_POST["nim"] ?>');
            $("#exampleSelectRounded1").val("<?= $_POST["angkatan"]; ?>")
            $("#exampleSelectRounded0").val("<?= $_POST["departemen"]; ?>");
            $("#exampleInputEmail1").attr('value', '<?= $_POST["email"] ?>');
